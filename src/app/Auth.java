...
public class Auth {
    ...
    public static Object get(Request req, Response res) {
        ...
        if (u.isCustomer()) return data.customers.singleToJson((Customer) u);
        else if (u.isSalesperson()) return data.salespeople.singleToJson((Salesperson) u);
        else return data.admins.singleToJson((Admin) u);
    }
